...
const TaskPixel = {
    ...
    DataStore: {
        ...
        addSubstepToGoal: function(taskId, goalId, substepContent) {
            ...
            this.saveToStorage();
            TaskPixel.EventBus.emit('substep:added', { taskId, goalId, substep: newSubstep });
            return substepId;
        },
        ...
        deleteGoal: function(taskId, goalId) {
            ...
            this.saveToStorage();
            TaskPixel.EventBus.emit('goal:deleted', { taskId, goalId, goal: deletedGoal });
            return true;
        },
        ...
        deleteSubstep: function(taskId, goalId, substepId) {
            ...
            this.saveToStorage();
            TaskPixel.EventBus.emit('substep:deleted', { taskId, goalId, substepId, substep: deletedSubstep });
            return true;
        },
        ...
        exportData: function() {
            try {
                ...
                const exportFileName = 'taskpixel_data_' + new Date().toISOString().slice(0, 10) + '.json';
        ...
        navigateTo: function(pageName, params = {}) {
            ...
            switch (pageName) {
                ...
                case 'task_detail':
                    ...
                    break;
                case 'ai_evaluation':
                    url = `ai_evaluation.html?taskId=${params.taskId || ''}&goalId=${params.goalId || ''}`;
                    break;
                case 'settings':
                    url = 'settings.html';
                    break;
